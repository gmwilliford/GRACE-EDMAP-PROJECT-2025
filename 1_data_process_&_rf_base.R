...
#STEP 1 GRACE PROCESSING
# Loading CONUS shapefile, declaring aquifer extents, converting to sf objects 
...
#Calculaing storage means over full CONUS
...
#Random Forest Base Model trained on entire continental US
set.seed(123)
